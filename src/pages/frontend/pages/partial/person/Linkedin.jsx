            ...
            <div className="row justify-content-center">
                <div className="col-md-8">
                    <form onSubmit={handleSubmit}
                        ...
                        <input type="text" placeholder="Enter LinkedIn URL e.g: https://www.linkedin.com/in/johndoe/" className="form-control rounded-5" required
                            onChange={
                                (e) => setLinkedinUrl(e.target.value)
                            }/>
                        <button type="submit" className="btn_orange btn_white">Search</button>
                    </form>
                </div>
            </div>
